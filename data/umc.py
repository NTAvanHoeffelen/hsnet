...
class DatasetUMC(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        self.fold = fold
        self.nfolds = 4                     # TO BE DETERMINED
        self.nclass = 20                    # TO BE DETERMINED
        self.benchmark = 'umc'           
        self.shot = shot
        self.use_original_imgsize = use_original_imgsize    # Should probably always be true

        self.img_path = os.path.join(datapath, 'VOC2012/JPEGImages/')               # Change to propper directory path
        self.ann_path = os.path.join(datapath, 'VOC2012/SegmentationClassAug/')     # Change to propper directory path
        self.transform = transform                                                  # should it contain data augmentation? --> test first without then with
